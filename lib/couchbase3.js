...
class Couchbase extends NoSQL {
  ...
  constructor(name, settings, Accessor) {
    ...
    this.defaultDesignDocs = defaultDesignDocs;
    if (settings.experiment && Array.isArray(settings.experiment)) {
      settings.experiment.forEach(feature => {
        const component = require(`./experiment/${feature}`);
        Object.assign(this, component.Couchbase);
        Object.assign(this._Accessor.prototype, component.Accessor);
      });
    }
  }
